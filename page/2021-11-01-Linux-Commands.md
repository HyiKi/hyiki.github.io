...
1. 将当前目录下的文件名格式从gbk转换成utf8

```shell
convmv --notest --nosmart -f gbk -t utf8 -r ./
```
...
3. 查看pid为<pid>的进程启动目录

```
ll /proc/<pid>| grep cwd
```

4. 查看一级文件夹大小、使用比例、档案系统及其挂入点（磁盘空间剩余情况）
